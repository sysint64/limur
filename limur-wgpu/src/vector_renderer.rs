...
impl VectorBindGroup {
    ...
    fn rebuild(
        ...
        self.bind_group = Self::create_bind_group(context, &self.layout, resources, globals_buffer);
    }
}
...
impl VectorRenderer {
                ...
                .create_render_pipeline(&wgpu::RenderPipelineDescriptor {
                    ...
                    fragment: Some(wgpu::FragmentState {
                        ...
                        targets: &[Some(wgpu::ColorTargetState {
                            ...
                            blend: Some(if context.dual_source_blending_support {
                                wgpu::BlendState {
    ...
    pub fn rebuild_text_atlas(&mut self, context: &GraphicsContext, resources: &TextResources) {
