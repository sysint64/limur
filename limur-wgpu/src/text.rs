...
impl InnerAtlas {
    ...
    fn new(context: &GraphicsContext, kind: Kind) -> Self {
...
impl TextAtlasBindGroup {
    pub fn new(context: &GraphicsContext, resources: &TextResources) -> Self {
        let layout = context
            .device
    ...
    pub(crate) fn rebuild(&mut self, context: &GraphicsContext, resources: &TextResources) {
...
impl TextResources {
    ...
    pub fn new(context: &GraphicsContext, format: wgpu::TextureFormat) -> Self {
