...
use limur_derive::{ShortcutId, ShortcutModifierId, ShortcutScopeId, WidgetBuilder, WidgetState};
...
pub(crate) struct State {
    ...
    pub(crate) mouse_path_x: f64,
    pub(crate) mouse_path_y: f64,
