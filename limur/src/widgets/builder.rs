...
pub trait WidgetBuilder {
    ...
    where
        Self: Sized,
    {
        self.frame_mut().id = ::limur::WidgetId::auto_with_seed(id);
        self.frame_mut().flags |= FrameBuilderFlags::ID;
        self
    }

    fn size<T: Into<::limur::Size>>(mut self, size: T) -> Self
    where
        Self: Sized,
    {
    ...
    fn width<T: Into<::limur::SizeConstraint>>(mut self, size: T) -> Self
    where
        Self: Sized,
    {
    ...
    fn height<T: Into<::limur::SizeConstraint>>(mut self, size: T) -> Self
    where
        Self: Sized,
    {
    ...
    where
        Self: Sized,
    {
        self.frame_mut().size.width = ::limur::SizeConstraint::Fill(1.);
        self.frame_mut().flags |= FrameBuilderFlags::SIZE;
        self
    }
    ...
    where
        Self: Sized,
    {
        self.frame_mut().size.height = ::limur::SizeConstraint::Fill(1.);
        self.frame_mut().flags |= FrameBuilderFlags::SIZE;
        self
    }
    ...
    fn constraints(mut self, constraints: ::limur::Constraints) -> Self
    where
        Self: Sized,
    {
    ...
    fn clip(mut self, clip: ::limur::Clip) -> Self
    where
        Self: Sized,
    {
    ...
    fn padding(mut self, padding: ::limur::EdgeInsets) -> Self
    where
        Self: Sized,
    {
    ...
    fn margin(mut self, margin: ::limur::EdgeInsets) -> Self
    where
        Self: Sized,
    {
    ...
    fn background(mut self, decorator: ::limur::WidgetRef) -> Self
    where
        Self: Sized,
    {
    ...
    fn foreground(mut self, decorator: ::limur::WidgetRef) -> Self
    where
        Self: Sized,
    {
